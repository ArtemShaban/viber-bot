...
class RateLevelRequest(state: BotLogicState) : UserRequest<RateLevelRequest.Option>(state) {
    ...
    override fun getMessage(): String {
        return when (Lang.valueOf(state.userLang!!)) {
            Lang.UK -> "Для нас важливо, щоб у вас було розуміння, що ми керуємося тільки вашими інтересами та хочемо допомогти. Тому ми поважаємо і гарантуємо  приватність та конфіденційність нашої розмови.\n\n" +
